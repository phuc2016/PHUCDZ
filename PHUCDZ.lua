-- discord.g"/ KHÔNG CÓ DISCORD


s"ared.LoaderTitle = "SCRIPT CỦA PHÚC";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://85929155012593",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=PHÚC DZ ";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/không có discord");
    end
});
